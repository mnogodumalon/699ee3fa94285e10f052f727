...
export function AnmeldungenDialog({ open, onClose, onSubmit, defaultValues, kurseList, teilnehmerList, enablePhotoScan = false, enablePhotoLocation = true }: AnmeldungenDialogProps) {
  ...
  async function handlePhotoScan(file: File) {
    ...
    try {
      ...
      setFields(prev => {
        ...
        const applookupKeys = new Set<string>(["kurs", "teilnehmer"]);
