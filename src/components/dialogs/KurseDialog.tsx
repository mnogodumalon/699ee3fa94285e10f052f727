...
export function KurseDialog({ open, onClose, onSubmit, defaultValues, dozentenList, raeumeList, enablePhotoScan = false, enablePhotoLocation = true }: KurseDialogProps) {
  ...
  async function handlePhotoScan(file: File) {
    ...
    try {
      ...
      contextParts.push(`<available-records field="dozent" entity="Dozenten">\n${JSON.stringify(dozentenList.map(r => ({ record_id: r.record_id, ...r.fields })), null, 2)}\n</available-records>`);
