...
import { IconArrowBackUp, IconBook, IconClipboardList, IconDoorEnter, IconLayoutDashboard, IconMenu2, IconSchool, IconSettings, IconUsers } from '@tabler/icons-react';
...
const navigation = [
  ...
  { name: 'Kurse', href: '/kurse', icon: IconBook },
  { name: 'Räume', href: '/raeume', icon: IconDoorEnter },
  { name: 'Teilnehmer', href: '/teilnehmer', icon: IconUsers },
  { name: 'Dozenten', href: '/dozenten', icon: IconSchool },
];

const externalNavigation = [
  { name: 'Anmeldungen', href: '/gateway/apps/699ee3e22aa88b70633078b7?template=list_page', icon: IconClipboardList },
  { name: 'Kurse', href: '/gateway/apps/699ee3e112521d4170b13729?template=list_page', icon: IconBook },
  { name: 'Räume', href: '/gateway/apps/699ee3e02163d9e789db68d8?template=list_page', icon: IconDoorEnter },
  { name: 'Teilnehmer', href: '/gateway/apps/699ee3e1c832fec5bc59278c?template=list_page', icon: IconUsers },
  { name: 'Dozenten', href: '/gateway/apps/699ee3d900d22745910618f9?template=list_page', icon: IconSchool },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/699ee3e22aa88b70633078b7?template=list_page"
